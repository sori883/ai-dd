...
| 意思決定 | [Codex receiverで配信本文を実読込する](decisions/2026-09-05-codex-receiver-read-plan.md) | Accepted（Issue #115、知識供給の包括承認内、配布用repo skill・fresh配置・live-gated実読込receipt。Stage実行とinstaller/updateは後続） |
