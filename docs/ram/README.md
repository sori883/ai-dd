...
- [外部由来skillに製品の接頭辞を付けない](decisions/2026-09-13-upstream-skill-names.md): ユーザーの直接修正依頼。11工程skillとOKFを原典名へ変更し、13翻案skillの作者・出典・翻案表示を明確にする。共通配置・承認等は維持し、参照名の変更に伴う工程hash変更は新規配置で扱う。
