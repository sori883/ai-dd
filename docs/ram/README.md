...
- [配布の仕上げを最小構成で進める](decisions/2026-09-11-distribution-packaging-scope.md): PR #164のmain反映・Issue #163完了。固定本家2.6.123のCodex配置と未提供upgradeを追加確認し、配布archive・照合値・3OS導入検査・手順による更新復旧を具体化。自動updater案は未採用。正式公開は別gate。TDDの4項目のRED/GREENと、archive照合・各OSでの実行を確認するfinal検証の入口を記録。
