...
| 意思決定 | [`intent-capture`を最初の通常Stageとして縦に通す](decisions/2026-09-06-intent-capture-vertical-milestone.md) | Accepted（Issue #118から開始。公開`report`は4 result、`HUMAN_TURN`はCodex `UserPromptSubmit` hookを正本とする直接承認。2 PRで基盤からStage完走へ進む） |
