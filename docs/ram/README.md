...
- [G0 fixtureのloop実装証拠](decisions/2026-09-10-agent-guard-preflight-evidence.md): 初回実機でStop後のprocess継続を観測。2回目で拒否成立・4故障caseの子開始を観測。拒否文と省略fieldの追従修復完了、再review・fresh final待ち。
