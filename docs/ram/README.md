...
| 意思決定 | [Intent作成の内部coreとworkspace lockの実装計画](decisions/2026-09-01-intent-create-core-plan.md) | Accepted（Issue #31、13項目TDD・review修正/再判定・6構成cross compile完了、PR待ち） |
...
| 調査 | [Intent作成coreの参照契約](research/2026-09-01-intent-create-contracts.md) | Current for local v2.6.123 snapshot（UUIDv7・registry・workspace lock・Bun Windows ICU契約・部分失敗） |
