...
| 意思決定 | [Codex向け配信transactionと公開next／continueを接続する](decisions/2026-09-05-delivery-publication-plan.md) | Accepted（知識供給の包括承認内。active-directive v2、same-token exactly-once、公開CLIと配布journey） |
