...
| 意思決定 | [初期 aidlc-state.md builderの実装計画](decisions/2026-09-02-initial-state-builder-plan.md) | Accepted（Issue #43、実装完了・独立review前） |
...
| 調査 | [初期 state builderの参照契約](research/2026-09-02-initial-state-builder-contracts.md) | Current for local v2.6.123 snapshot（canonical state・sidecar・routing・Greenfield補正） |
