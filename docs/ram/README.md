...
| 意思決定 | [配置済み情報からcanonical run-stageをread-only構成する](decisions/2026-09-05-run-stage-composition-plan.md) | Accepted（Issue #109、fresh配置読込・canonical wire・route/state/rule freshness、知識供給の包括承認内） |
