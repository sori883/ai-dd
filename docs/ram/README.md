...
| 意思決定 | [Codex向け配信transactionと公開next／continueを接続する](decisions/2026-09-05-delivery-publication-plan.md) | Implemented（Issue #113、active-directive v2、same-token exactly-once、公開CLIと配布journey。破損markerは`next`がfresh recovery、`continue`はtyped error） |
