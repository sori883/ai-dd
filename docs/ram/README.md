...
| 意思決定 | [Codexのcontext読込をGoの安全境界へ移す](decisions/2026-09-05-codex-safe-context-read-contract.md) | Accepted（Issue #115の独立review修正。公開`read-context`、active binding、project内通常file限定を直接承認） |
