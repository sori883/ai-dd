...
- [工程skillとKagome版日本語チェックの実装](decisions/2026-09-12-stage-skills-natural-japanese-go-implementation.md): Issue #179。11工程skillとGo版skill、14分類の別CLI、配布・hook読取りを接続。依存はKagome/UniDic/共通辞書の3追加module。13項目TDDと親の対象確認を実施し、review/finalは別gate。
