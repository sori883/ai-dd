...
| 意思決定 | [`intent-capture`を最初の通常Stageとして縦に通す](decisions/2026-09-06-intent-capture-vertical-milestone.md) | Partially Superseded（Issue #118から開始。公開`report`と2 PR構成は維持。`HUMAN_TURN`の認証保証は下記の運用証拠へ置換） |
